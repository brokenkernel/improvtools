...
dependencies {
    ...
    dokka(projects.features.buzzer)
    dokka(projects.features.tonguetwister)
    dokka(projects.features.timer)
    dokka(projects.features.encyclopaedia.android)
    dokka(projects.features.encyclopaedia.data)
    dokka(projects.features.suggestions.android)
    dokka(projects.features.suggestions.data)
    dokka(projects.features.debug)
