...
internal val TongueTwisterDatum: ImmutableList<TongueTwisterItem> = persistentListOf(
    ...
    TongueTwisterItem("""Brisk brave brigadiers brandished broad bright blades, blunderbusses, and bludgeons—balancing them badly."""),
    TongueTwisterItem("""The sixth sick sheik's sixth sheep's sick."""),
    TongueTwisterItem("""If practice makes perfect and perfect needs practice, I’m perfectly practised and practically perfect."""),
    TongueTwisterItem("""If you must cross a course cross cow across a crowded cow crossing, cross the cross coarse cow across the crowded cow crossing carefully."""),
    TongueTwisterItem("""I thought a thought. But the thought I thought wasn’t the thought I thought I thought. If the thought I thought I thought had been the thought I thought, I wouldn’t have thought I thought."""),
